...
const { invitePatient, acceptLink, getMyPatients, getMyInvites } = require('../controllers/caregiverController');
...
router.get('/invites', requireAuth, requireRole('patient'), getMyInvites);
